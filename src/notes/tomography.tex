...
answer for why}. THIS NEEDS EXPLAINING IN FULL IN DISSERTATION. The operators $E_k$ are known as
\textit{operation elements}. This form is incredibly useful for tomography, which is covered in the
following sections.
